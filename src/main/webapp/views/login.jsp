			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 additional-nav">
					<ul class="list-unstyled list-inline pull-right">
						...
						<li><a href="/ltweb/views/register.jsp">Registration</a></li>
					</ul>
				</div>
				<!-- END TOP BAR MENU -->
			</div>
	...
	<div class="main">
		<div class="container">
			...
			<div class="row margin-bottom-40">
				...
				<!-- BEGIN CONTENT -->
				<form id="loginForm" action="/ltweb/login" method="POST">
					<div class="col-md-9 col-sm-9">
					<c:if test="${alert !=null}">
							<h3 class="lert alert-danger">${alert}</h3>
						</c:if>
						<h1>Login</h1>
									...
									<form class="form-horizontal form-without-legend" role="form">
										...
										<div class="row">
											<div class="col-lg-8 col-md-offset-4 padding-left-0">
												<a href = "/ltweb/views/forgotpass.jsp" id = "forgot-btn" >Forget Password?</a>
											</div>
										</div>
										<div class="row">
											<div
...
<body>
	...
	<button class="psw" id = "forgot-btn" value="forgot" onclick="redirectToLogin()">
		<a>Forgot password </a>
	</button>
	<script>
	...
	document.getElementById("forgot-btn").addEventListener("click",
			...
			window.location.href = "views/forgotpass.jsp";
		}
	</script>
</body>
</html>
