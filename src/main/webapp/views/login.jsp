					...
					<div class="content-form-page">
						<div class="row">
							<div class="col-md-9 col-sm-9">
								<form class="form-horizontal form-without-legend" action="${pageContext.request.contextPath}/login" method = "POST">
									...
									<div class="row">
										<div class="col-lg-8 col-md-offset-4 padding-left-0">
											<a href="${pageContext.request.contextPath }/forgot">Forget
												Password?</a>
										</div>
									</div>
									<div class="row">
