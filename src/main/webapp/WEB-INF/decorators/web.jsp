			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 additional-nav">
					<ul class="list-unstyled list-inline pull-right">
						...
						<li><a href="/ltweb/views/login.jsp">Log In</a></li>
					</ul>
				</div>
				<!-- END TOP BAR MENU -->
			</div>
					...
					<li class="dropdown active"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							...
							<li><a href="shop-index-light-footer.html">Home Light
									Footer</a></li>
							<li class="active"><a href="shop-product-list.html">Product
									List</a></li>
					...
					<div class="row product-list">
						...
						<div class="col-md-4 col-sm-6 col-xs-12">
							<div class="product-item">
								...
								<h3>
									<a href="shop-item.html">Berry Lace Dress Berry Lace Dress</a>
								</h3>
								<div class="pi-price">$29.00</div>
								<a href="#" class="btn btn-default add2cart">Add to cart</a>
							</div>
