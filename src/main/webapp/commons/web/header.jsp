        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 additional-nav">
					...
					<li><c:if test="${not empty sessionScope.account}">
							<a href="${pageContext.request.contextPath}/uploadmulti">My
								Account</a>
...
<link
	...
	rel="stylesheet" type="text/css">
<!-- for slider-range -->
<link href="${URL}assets/global/plugins/rateit/src/rateit.css"
	rel="stylesheet" type="text/css">
